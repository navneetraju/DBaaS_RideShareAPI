...
@app.route("/api/v1/rides",methods=['GET','DELETE','PUT'])
def create_ride1():
	cur=mysql.connection.cursor()
	cur.execute("UPDATE counter SET count = count + 1")
	mysql.connection.commit()
...
@app.route("/api/v1/rides",methods=['PUT','DELETE','POST'])
def get_rides1():
	cur=mysql.connection.cursor()
	cur.execute("UPDATE counter SET count = count + 1")
	mysql.connection.commit()
...
@app.route("/api/v1/rides/<rideId>",methods=['PUT','DELETE','POST'])
def ride_details1(rideId):
	cur=mysql.connection.cursor()
	cur.execute("UPDATE counter SET count = count + 1")
	mysql.connection.commit()
	cur.close()
...
@app.route("/api/v1/rides/<rideId>",methods=['PUT','DELETE','GET'])
...
@app.route("/api/v1/rides/<rideId>",methods=['POST','PUT','GET'])
